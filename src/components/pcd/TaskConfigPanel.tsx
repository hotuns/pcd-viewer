...
import { Upload, Link as LinkIcon, X, Map, AlertCircle, CheckCircle2 } from "lucide-react";
...
export function TaskConfigPanel({ selectedMission, onMissionUpdate }: TaskConfigPanelProps) {
  ...
  const updateSceneFile = (file: File) => {
    persist({ scene: { type: "file", file } });
  };
