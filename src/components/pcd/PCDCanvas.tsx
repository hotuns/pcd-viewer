...
export const PCDCanvas = forwardRef<PCDCanvasHandle, PCDCanvasProps>(function PCDCanvas(
  { source, pointSize = 0.01, showGrid = true, showAxes = true, onLoadedAction, onLoadingChange },
  ref
) {
    ...
    <Canvas camera={{ position: [2, 2, 2], fov: 60 }} dpr={[1, 2]}>
      ...
      {geom && (
        <points geometry={geom} frustumCulled={false}>
          <pointsMaterial size={pointSize} sizeAttenuation vertexColors={!!geom.getAttribute("color")} />
        </points>
      )}
